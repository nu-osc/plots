...
- [Plotting scripts](samples/theta13/theta13-v10-)
- Data tables:
    * [published](theta13_v10_published.dat)
    * [latest](theta13_v10_latest.dat)
- Cross checks by:
    * @ldkolupaeva
    * @maxfl
- Notes:
...
![sin²2θ₁₃](png/latest/double/theta13_v10_latest_global_future.png)

#### Experiments only
![sin²2θ₁₃](png/latest/double/theta13_v10_latest.png)

### sin²θ₁₃

####  Including global analyses and future experiments
![sin²2θ₁₃](png/latest/single/stheta13_v10_latest_global_future.png)

#### Experiments only
![sin²2θ₁₃](png/latest/single/stheta13_v10_latest.png)
