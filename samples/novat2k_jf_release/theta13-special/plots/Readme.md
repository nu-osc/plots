...
- [Plotting scripts](samples/theta13/theta13-v1-special)
- Data tables:
    * [published](theta13_v1_published.dat)
    * [latest](theta13_v1_latest.dat)
- Cross checks by:
    * @ldkolupaeva
    * @maxfl
- Notes:
...
![sin²2θ₁₃](png/latest/theta13_v1_latest_global_future.png)

### Experiments only
![sin²2θ₁₃](png/latest/theta13_v1_latest.png)
