...
- [Plotting scripts](samples/theta23/theta23-v1-special)
- Data tables:
    * [NO table](theta23_NO_v1.dat)
    * [IO table](theta23_IO_v1.dat)
- Notes:
...
![sin²θ₂₃ NO](png/NO/latest/theta23_v1_NO_latest_global_future.png)

![sin²θ₂₃ IO](png/IO/latest/theta23_v1_IO_latest_global_future.png)


### Experiments only

![sin²θ₂₃ NO](png/NO/latest/theta23_v1_NO_latest.png)

![sin²θ₂₃ IO](png/IO/latest/theta23_v1_IO_latest.png)
