...
def main(args):
    ...
    # Draw tag
    #
    ax.text(0.97, 0.77, 'v3 2025.02: git.jinr.ru/nu/osc', rotation=90, color='xkcd:greyish', transform=fig.transFigure, fontsize=11)
