...
- [Plotting scripts](samples/dm32/dm32-v7-dayabay)
- Data tables:
    * [NO published](dm32_v7b_NO_published.dat)
    * [IO published](dm32_v7b_IO_published.dat)
    * [NO latest](dm32_v7b_NO_latest.dat)
    * [IO latest](dm32_v7b_IO_latest.dat)
- Conversions:
...
![\|Δm²₃₂\| NO](png/NO/latest/dm32_v7b_NO_latest_global_future.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32_v7b_IO_latest_global_future.png)

### Including global analyses

![\|Δm²₃₂\| NO](png/NO/latest/dm32_v7b_NO_latest_global.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32_v7b_IO_latest_global.png)

### Experiments only

![\|Δm²₃₂\| NO](png/NO/latest/dm32_v7b_NO_latest.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32_v7b_IO_latest.png)
