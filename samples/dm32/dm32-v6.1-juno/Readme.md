...
![\|Δm²₃₂\| NO](png/NO/latest/${variable}_v${version_dash}${beta}_NO_latest_global_future.png)

![\|Δm²₃₂\| IO](png/IO/latest/${variable}_v${version_dash}${beta}_IO_latest_global_future.png)

### Including global analyses

![\|Δm²₃₂\| NO](png/NO/latest/${variable}_v${version_dash}${beta}_NO_latest_global.png)

![\|Δm²₃₂\| IO](png/IO/latest/${variable}_v${version_dash}${beta}_IO_latest_global.png)

### Experiments only

![\|Δm²₃₂\| NO](png/NO/latest/${variable}_v${version_dash}${beta}_NO_latest.png)

![\|Δm²₃₂\| IO](png/IO/latest/${variable}_v${version_dash}${beta}_IO_latest.png)
...
| Daya Bay nGd   |                                               |                                                        |          [hep-ex/1809.02261](data/dayabay_2018-06-neutrino2018.yaml) |
