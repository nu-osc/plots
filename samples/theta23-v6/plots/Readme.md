...
- Version: **6**
- Updates since v4:
    * New IceCube, T2K, NOvA results
- [Plotting scripts](samples/theta23/theta23-v6-)
- Data tables:
    * [NO table](theta23_NO_v6.dat)
    * [IO table](theta23_IO_v6.dat)
- Notes:
...
![sin²θ₂₃ NO](png/NO/latest/theta23_v6_NO_latest_global_future.png)

![sin²θ₂₃ IO](png/IO/latest/theta23_v6_IO_latest_global_future.png)


### Experiments only

![sin²θ₂₃ NO](png/NO/latest/theta23_v6_NO_latest.png)

![sin²θ₂₃ IO](png/IO/latest/theta23_v6_IO_latest.png)
