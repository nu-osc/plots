...
- [Plotting scripts](samples/dm32/dm32-v11-none)
- Conversions:
...
![\|Δm²₃₂\| NO](png/NO/latest/dm32/dm32_v11_NO_latest_global_future.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32/dm32_v11_IO_latest_global_future.png)

#### Including global analyses

![\|Δm²₃₂\| NO](png/NO/latest/dm32/dm32_v11_NO_latest_global.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32/dm32_v11_IO_latest_global.png)

#### Experiments only

![\|Δm²₃₂\| NO](png/NO/latest/dm32/dm32_v11_NO_latest.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32/dm32_v11_IO_latest.png)

### |Δm²₃₁|

#### Including global analyses and future experiments

![\|Δm²₃₁\| NO](png/NO/latest/dm31/dm31_v11_NO_latest_global_future.png)

![\|Δm²₃₁\| IO](png/IO/latest/dm31/dm31_v11_IO_latest_global_future.png)

#### Including global analyses

![\|Δm²₃₁\| NO](png/NO/latest/dm31/dm31_v11_NO_latest_global.png)

![\|Δm²₃₁\| IO](png/IO/latest/dm31/dm31_v11_IO_latest_global.png)

#### Experiments only

![\|Δm²₃₁\| NO](png/NO/latest/dm31/dm31_v11_NO_latest.png)

![\|Δm²₃₁\| IO](png/IO/latest/dm31/dm31_v11_IO_latest.png)
