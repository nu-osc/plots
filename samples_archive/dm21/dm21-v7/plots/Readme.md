...
- [Plotting scripts](samples/dm21/dm21-v7-)
- Data tables:
    * [published](dm21_v7_published.dat)
    * [latest](dm21_v7_latest.dat)
- Cross checks by:
    * @ldkolupaeva
    * @maxfl
- Notes:
...
![Δm²₂₁](png/latest/dm21_v7_latest_global_future.png)

### Including global analyses

![Δm²₂₁](png/latest/dm21_v7_latest_global.png)

### Experiments only

![Δm²₂₁](png/latest/dm21_v7_latest.png)
