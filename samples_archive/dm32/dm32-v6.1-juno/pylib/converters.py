...
def splitting_large_32NO(dm32NO, context):
    ordering = context['ordering']=='NO' and 1.0 or -1.0
    if ordering==1.0:
        return dm32NO
...
def splitting_large_32NO_31IO(dm32NO_31IO, context):
    ordering = context['ordering']=='NO' and 1.0 or -1.0
    if ordering==1.0:
        return dm32NO_31IO

    return splitting_large_31(dm32NO_31IO, context)
...
converters = dict(
        ...
        splitting_large={
            '32': unity,
            '32NO': splitting_large_32NO,
            '32NO/31IO': splitting_large_32NO_31IO,
            'ee': splitting_large_ee,
            '31': splitting_large_31,
            'avg' : splitting_large_avg
        }
        )
