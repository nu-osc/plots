...
- [Plotting scripts](samples/theta12/theta12-v9-)
- Data tables:
    * [published](theta12_v9_published.dat)
    * [latest](theta12_v9_latest.dat)
- Cross checks by:
    * @ldkolupaeva
    * @maxfl
- Notes:
...
![sin²θ₁₂](png/latest/theta12_v9_latest.png)

###  Including global analyses and future experiments

![sin²θ₁₂](png/latest/theta12_v9_latest_global_future.png)

### Including global analyses

![sin²θ₁₂](png/latest/theta12_v9_latest_global.png)
...
| JUNO              |                                                                   [hep-ex/2511.14593](data/juno_2025-11_nature.yaml) |    [Neutrino 2026](data/juno_2026-06_neutrino2026.yaml) |
