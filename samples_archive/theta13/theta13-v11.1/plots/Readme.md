...
- Version: **11.1**
- Updates since v11:
    * Add Daya Bay nH+nGd result on the full dataset
- [Plotting scripts](samples/theta13/theta13-v11.1-)
- Data tables:
    * [published](theta13_v11-1_published.dat)
    * [latest](theta13_v11-1_latest.dat)
- Cross checks by:
    * @ldkolupaeva
    * @maxfl
- Notes:
...
![sin²2θ₁₃](png/latest/double/theta13_v11-1_latest_global_future.png)

#### Experiments only
![sin²2θ₁₃](png/latest/double/theta13_v11-1_latest.png)

### sin²θ₁₃

####  Including global analyses and future experiments
![sin²2θ₁₃](png/latest/single/stheta13_v11-1_latest_global_future.png)

#### Experiments only
![sin²2θ₁₃](png/latest/single/stheta13_v11-1_latest.png)
...
| Daya Bay nH     |          [hep-ex/1603.03549](data/dayabay_2016-07-neutrino2016.yaml) |           [hep-ex/2406.01007](data/dayabay_2024-06-nH.yaml) |
