...
- Data tables:
    * [NO published](dm32_v7_NO_published.dat)
    * [IO published](dm32_v7_IO_published.dat)
    * [NO latest](dm32_v7_NO_latest.dat)
    * [IO latest](dm32_v7_IO_latest.dat)
- Conversions:
...
![\|Δm²₃₂\| NO](png/NO/latest/dm32_v7_NO_latest_global_future.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32_v7_IO_latest_global_future.png)

### Including global analyses

![\|Δm²₃₂\| NO](png/NO/latest/dm32_v7_NO_latest_global.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32_v7_IO_latest_global.png)

### Experiments only

![\|Δm²₃₂\| NO](png/NO/latest/dm32_v7_NO_latest.png)

![\|Δm²₃₂\| IO](png/IO/latest/dm32_v7_IO_latest.png)
