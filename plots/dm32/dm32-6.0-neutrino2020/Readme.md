...
- Data tables:
    * [NO table](dm32_NO_v6-0.dat)
    * [IO table](dm32_IO_v6-0.dat)
- References:
...
![\|Δm²₃₂\| NO](dm32_NO_global_future_v6-0.png)

![\|Δm²₃₂\| IO](dm32_IO_global_future_v6-0.png)

## Including global analyses

![\|Δm²₃₂\| NO](dm32_NO_global_v6-0.png)

![\|Δm²₃₂\| IO](dm32_IO_global_v6-0.png)

## Experiments only

![\|Δm²₃₂\| NO](dm32_NO_v6-0.png)

![\|Δm²₃₂\| IO](dm32_IO_v6-0.png)
