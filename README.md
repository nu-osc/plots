...
| Note                      | $`\sin^2 \theta_{23}`$                              | $`\delta_\mathrm{\scriptscriptstyle\mathrm{CP}}`$ | $`\delta_\mathrm{\scriptscriptstyle\mathrm{CP}}`$ resolution     | $`\delta_\mathrm{\scriptscriptstyle\mathrm{CP}}`$         | NMO                                 | MO sens.                                    |
| -------------             | ------:                                             | ------:                                           | ------------------:                                              |                                                           | ------:                             | ------:                                     |
